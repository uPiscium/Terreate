...
//   // mInstance =
//   //     Terreate::API::createInstance("VulkanTriangle", {1, 0, 0},
//   mDebugger);
// }
...
//   nullptr); std::vector<VkQueueFamilyProperties>
...
//   this->pickSurfaceFormat(details.formats); VkPresentModeKHR presentMode =
//   this->pickPresentMode(details.presentModes); VkExtent2D extent =
//   this->pickExtent(details.capabilities);
...
//   imgCount =
//       ((maxImgCount > 0) && (imgCount > maxImgCount)) ? maxImgCount :
//       imgCount;
...
//   VK_SUBPASS_CONTENTS_INLINE); vkCmdBindPipeline(cmdBuffer,
