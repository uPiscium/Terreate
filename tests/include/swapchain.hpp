...
// private:
//   VkSurfaceFormatKHR pickSurfaceFormat(vec<VkSurfaceFormatKHR> const
//   &formats); VkPresentModeKHR pickPresentMode(vec<VkPresentModeKHR> const
//   &presentModes); VkExtent2D pickExtent(GLFWwindow *window,
