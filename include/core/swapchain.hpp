...
public:
  ...
  virtual void recreate(Type::pair<Type::i32> framebufferSize,
                        VkObjectRef<ISurface> surface) = 0;
...
public:
  ...
  void recreate(Type::pair<Type::i32> framebufferSize,
                VkObjectRef<ISurface> surface) override {}
  void dispose();
