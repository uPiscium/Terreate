...
public:
  ...
  virtual void setRenderPass(VkObjectRef<ISwapchain> swapchain,
                             VkObjectRef<IPipeline> pipeline,
                             VkObjectRef<IRenderPass> renderpass,
                             VkObjectRef<IFramebuffer> framebuffer,
...
public:
  ...
  ~CommandPool() override { this->dispose(); }
...
public:
  ...
  ~CommandBuffer() override { this->dispose(); }

  void setRenderPass(VkObjectRef<ISwapchain> swapchain,
                     VkObjectRef<IPipeline> pipeline,
                     VkObjectRef<IRenderPass> renderpass,
                     VkObjectRef<IFramebuffer> framebuffer,
                     Type::vec<float> const &clearColor,
