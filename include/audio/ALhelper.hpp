...
typedef void (*FPALGENSOURCES)(i32 n, u32 *sources);
typedef void (*FPALDELETESOURCES)(i32 n, u32 const *sources);
typedef bool (*FPALISSOURCE)(u32 source);

typedef void (*FPALSOURCEF)(u32 source, ALenum param, ALfloat value);
typedef void (*FPALSOURCE3F)(u32 source, ALenum param, ALfloat value1,
                             ALfloat value2, ALfloat value3);
typedef void (*FPALSOURCEFV)(u32 source, ALenum param, ALfloat const *values);
typedef void (*FPALSOURCEI)(u32 source, ALenum param, ALint value);
typedef void (*FPALSOURCE3I)(u32 source, ALenum param, ALint value1,
                             ALint value2, ALint value3);
typedef void (*FPALSOURCEIV)(u32 source, ALenum param, ALint const *values);

typedef void (*FPALGETSOURCEF)(u32 source, ALenum param, ALfloat *value);
typedef void (*FPALGETSOURCE3F)(u32 source, ALenum param, ALfloat *value1,
                                ALfloat *value2, ALfloat *value3);
typedef void (*FPALGETSOURCEFV)(u32 source, ALenum param, ALfloat *values);
typedef void (*FPALGETSOURCEI)(u32 source, ALenum param, ALint *value);
typedef void (*FPALGETSOURCE3I)(u32 source, ALenum param, ALint *value1,
                                ALint *value2, ALint *value3);
typedef void (*FPALGETSOURCEIV)(u32 source, ALenum param, ALint *values);
