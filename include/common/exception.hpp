...
class QueueRetrievalFailure : public VulkanAPIError {
public:
  QueueRetrievalFailure(Type::str const &message) : VulkanAPIError(message) {}
};
...
class SyncObjectCreationFailure : public VulkanAPIError {
public:
  SyncObjectCreationFailure(Type::str const &message)
      : VulkanAPIError(message) {}
};

class SyncObjectWaitFailure : public VulkanAPIError {
public:
  SyncObjectWaitFailure(Type::str const &message) : VulkanAPIError(message) {}
};

class SyncObjectResetFailure : public VulkanAPIError {
public:
  SyncObjectResetFailure(Type::str const &message) : VulkanAPIError(message) {}
};

class QueueSubmitFailure : public VulkanAPIError {
public:
  QueueSubmitFailure(Type::str const &message) : VulkanAPIError(message) {}
};

class InvalidArgument : public TerreateException {
public:
  InvalidArgument(Type::str const &message) : TerreateException(message) {}
};
